...
{
    public partial class queryInboxDocGUIDList : Form
    {
        ...
        private void queryInboxDocGUIDList_Load(object sender, EventArgs e)
        {
            // Form_Load içinde:
        ...
        public queryInboxDocGUIDList()
        {
            InitializeComponent();
        }

        private void btnQueryInboxDocLocalId_Click(object sender, EventArgs e)
        {
