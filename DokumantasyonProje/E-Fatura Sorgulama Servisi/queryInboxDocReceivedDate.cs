...
{
    public partial class queryInboxDocReceivedDate : Form
    {
        ...
        public queryInboxDocReceivedDate()
        {
            InitializeComponent();
        }
        private void queryInboxDocReceivedDate_Load(object sender, EventArgs e)
        {
            // Form_Load içinde:
        ...
        private void btnQueryInboxDocReceivedDate_Click(object sender, EventArgs e)
        {
            ...
            using (var scope = new OperationContextScope(client.InnerChannel))
            {
                ...
                var outdocreceivedate = client.QueryInboxDocumentsWithDocumentDate(startDate, finishDate, documentType, queried, withXML, takenFromEntegrator, minRecordId);
                ...
                {
                    string mesaj2 = "Hata durumu: " + outdocreceivedate.queryState.ToString() + Environment.NewLine +
                    "Açıklama: " + outdocreceivedate.stateExplanation + Environment.NewLine;
